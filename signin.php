        ...
        <div class="main-wrapper">
			<div class="account-content">
				<div class="login-wrapper">
                            ...
                            <form method="post" id="signin">
                                ...
                                <div class="form-login">
                                    <div class="alreadyuser">
                                        <h4><a href="https://dreamspos.dreamstechnologies.com/html/template/forgetpassword.html" class="hover-a">Forgot Password?</a></h4>
                                    </div>
                                </div>
                                <div class="form-login">
                    ...
                    <div class="login-img">
                        <img src="https://dreamspos.dreamstechnologies.com/html/template/assets/img/login.jpg" alt="img">
                    </div>
                </div>
			</div>
        </div>
